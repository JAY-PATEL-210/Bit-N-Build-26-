...
// Launch page exact dark background color matching globals.css body and tailwind theme
const LAUNCH_DARK_BG = "#020617";
...
<body class="text-slate-300 antialiased min-h-screen flex flex-col selection:bg-slate-700 selection:text-white relative" style="background-color: #020617; font-family: 'Inter', sans-serif;">
    ...
    <div class="fixed inset-0 z-0 overflow-hidden" style="background-color: #020617;">
        <div class="absolute inset-0 z-0 opacity-10" style="background: radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.01) 0%, rgba(2, 6, 23, 0) 80%);"></div>
    ...
    <main class="flex-grow flex flex-col items-center justify-center relative z-30 px-6 py-12 min-h-screen w-full">
        ...
        <div class="max-w-md w-full bg-[#020617]/95 backdrop-blur-xl rounded-2xl p-7 md:p-8 shadow-2xl flex flex-col relative group">
...
const GATEWAY_FLOW_DEFINITION: EffectDefinition = {
  ...
  supportsMode: true,
  background: (mode) => (mode === "light" ? LIGHT_PAPER : LAUNCH_DARK_BG),
